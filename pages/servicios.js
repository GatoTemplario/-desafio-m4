function importThings() {
  ...
  function getPortfolio() {
    const apiURL = new URL(
      "https://cdn.contentful.com/spaces/1kcpq4cdqvpo/environments/master/entries/?access_token=8t2ILVt0J-hwcOSPX19ujlLFYt8sAPQY5ghYHveEqrw&content_type=serviciosCard"
    );
    return fetch(apiURL)
      .then((res) => {
        return res.json();
      ...
      .then((json) => {
        ...
        const cardCollection = array.map((item) => {
          return {
            title: item.fields.serviciosTitle,
            text: item.fields.serviciosText,
